...
The markdown cells have static appearance, but in the code cells the existing font may **not** be the one desired. In Firefox this can be fixed in **settings** by setting the Monospace font choice to the desired font (such as Monaco), while at the same time unchecking the "allow pages to choose ..." checkbox. 
